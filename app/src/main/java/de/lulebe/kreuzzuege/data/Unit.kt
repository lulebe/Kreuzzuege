    ...
    companion object {
        val Data = mapOf<Int, UnitData>(
                Pair(Type.GUARD, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 1,
                        attackNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 0, 0),
                        defenseNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 1, 1),
                        moveAndFight = true,
                        movementPoints = 4,
                ...
                Pair(Type.SPEAR, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 1,
                        attackNumberOfFights = arrayOf(0, 3, 3, 3, 3, 5, 5, 5, 1, 1, 1, 3, 0, 0),
                        defenseNumberOfFights = arrayOf(0, 3, 3, 3, 3, 5, 5, 5, 1, 1, 1, 3, 1, 2),
                        moveAndFight = true,
                        movementPoints = 5,
                ...
                Pair(Type.SWORD, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 1,
                        attackNumberOfFights = arrayOf(0, 4, 4, 4, 4, 2, 2, 2, 2, 2, 2, 4, 0, 0),
                        defenseNumberOfFights = arrayOf(0, 4, 4, 4, 4, 2, 2, 2, 2, 2, 2, 4, 1, 1),
                        moveAndFight = true,
                        movementPoints = 5,
                        movementCosts = arrayOf(0,-1, 2, 2, 3, 3, 1, -1, 3),
                ...
                Pair(Type.ARCHER, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 2,
                        attackNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 2, 3),
                        defenseNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 2, 3),
                        moveAndFight = true,
                        movementPoints = 6,
                        movementCosts = arrayOf(0, -1, 2, 2, 3, 3, 1, -1, 3),
                ...
                Pair(Type.LIGHT_KAV, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 1,
                        attackNumberOfFights = arrayOf(0, 4, 4, 4, 4, 3, 3, 3, 2, 2, 2, 4, 0, 0),
                        defenseNumberOfFights = arrayOf(0, 4, 4, 4, 4, 3, 3, 3, 2, 2, 2, 4, 1, 2),
                        moveAndFight = true,
                        movementPoints = 8,
                        movementCosts = arrayOf(0, -1, 2, 2, 3, 3, 1, -1, 3),
                ...
                Pair(Type.ARCHER_KAV, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 2,
                        attackNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 2, 4),
                        defenseNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 2, 4),
                        moveAndFight = true,
                        movementPoints = 8,
                        movementCosts = arrayOf(0, -1, 2, 2, 3, 3, 1, -1, 3),
                ...
                Pair(Type.HEAVY_KAV, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 1,
                        attackNumberOfFights = arrayOf(0, 5, 5, 5, 5, 4, 4, 4, 3, 3, 3, 5, 0, 0),
                        defenseNumberOfFights = arrayOf(0, 5, 5, 5, 5, 4, 4, 4, 3, 3, 3, 5, 2, 3),
                        moveAndFight = true,
                        movementPoints = 7,
                        movementCosts = arrayOf(0, -1, 2, 2, 3, 3, 1, -1, 3),
                ...
                Pair(Type.CATAPULT, UnitData(
                        ...
                        minAttackDistance = 2,
                        maxAttackDistance = 3,
                        attackNumberOfFights = arrayOf(0, 1, 1, 1, 1, 1, 1, 1, 3, 3, 3, 1, 2, 0),
                        defenseNumberOfFights = arrayOf(0, 1, 1, 1, 1, 1, 1, 1, 3, 3, 3, 1, 2, 1),
                        moveAndFight = false,
                        movementPoints = 4,
                ...
                Pair(Type.BALLISTA, UnitData(
                        ...
                        minAttackDistance = 2,
                        maxAttackDistance = 4,
                        attackNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 1, 1),
                        defenseNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 1, 1),
                        moveAndFight = false,
                        movementPoints = 4,
                        movementCosts = arrayOf(0, -1, 2, -1, 4, -1, 1, -1, -1),
                ...
                Pair(Type.TREBUCHET, UnitData(
                        ...
                        minAttackDistance = 2,
                        maxAttackDistance = 4,
                        attackNumberOfFights = arrayOf(0, 2, 2, 2, 2, 1, 1, 1, 4, 4, 4, 2, 1, 0),
                        defenseNumberOfFights = arrayOf(0, 2, 2, 2, 2, 1, 1, 1, 4, 4, 4, 2, 1, 0),
                        moveAndFight = false,
                        movementPoints = 3,
                ...
                Pair(Type.TOWER, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 2,
                        attackNumberOfFights = arrayOf(0, 3, 3, 3, 3, 2, 2, 2, 1, 1, 1, 3, 1, 3),
                        defenseNumberOfFights = arrayOf(0, 4, 4, 4, 4, 3, 3, 3, 1, 1, 1, 4, 1, 3),
                        moveAndFight = false,
                        movementPoints = 3,
                        movementCosts = arrayOf(0, -1, 2, -1, -1, -1, 1, -1, -1),
                ...
                Pair(Type.SHIP, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 1,
                        attackNumberOfFights = arrayOf(0, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 0),
                        defenseNumberOfFights = arrayOf(0, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 1),
                        moveAndFight = true,
                        movementPoints = 8,
                ...
                Pair(Type.AIR, UnitData(
                        ...
                        minAttackDistance = 1,
                        maxAttackDistance = 1,
                        attackNumberOfFights = arrayOf(0, 4, 4, 4, 4, 2, 2, 2, 2, 2, 2, 4, 2, 3),
                        defenseNumberOfFights = arrayOf(0, 4, 4, 4, 4, 2, 2, 2, 2, 2, 2, 4, 2, 3),
                        moveAndFight = true,
                        movementPoints = 10,
                        movementCosts = arrayOf(0, 1, 1, 1, 1, 1, 1, 1, 1),
